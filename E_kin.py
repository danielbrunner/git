...
d_r=400
r=np.sqrt(np.arange(1,25)*d_r)      # geometrical spreading
r[0]=1
...
# read data from file
stri='/home/djamel/PHD_projects/scatering_Paper/seismogram/model_3/seismogram_3_1_exp/Model_3_1_exp_vx.bin'
vx=np.fromfile(stri, dtype='<f4')
vx=np.reshape(vx, (14,24*4, 1000))

stri='/home/djamel/PHD_projects/scatering_Paper/seismogram/model_3/seismogram_3_1_exp/Model_3_1_exp_vy.bin'
vy=np.fromfile(stri, dtype='<f4')
vy=np.reshape(vy, (14,24*4, 1000))

stri='/home/djamel/PHD_projects/scatering_Paper/seismogram/model_3/seismogram_3_1_exp/Model_3_1_exp_vz.bin'
...
for ii in range(0,24):
    a_m[ii]=np.mean(at_5[:,ii])*r[ii]
    disp_m[ii]=np.mean(disp[:,ii])*r[ii]
